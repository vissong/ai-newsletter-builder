#!/usr/bin/env python3
"""Search for AI security incidents and vulnerabilities via Tavily CLI."""
...
QUERY = '"AI security" OR "AI vulnerability" OR "AI breach" OR "LLM exploit" OR "prompt injection"'
TOPIC = "news"
TIME_RANGE = "week"
MAX_RESULTS = 15
LANGUAGE = "en"
...
INCLUDE_DOMAINS = []
EXCLUDE_DOMAINS = []
EXCLUDE_KEYWORDS = ["sponsored", "promoted", "advertisement", "webinar", "white paper"]
...
def main():
    ...
    for r in data.get("results", []):
        ...
        if any(kw.lower() in content[:200].lower() for kw in EXCLUDE_KEYWORDS):
            continue
